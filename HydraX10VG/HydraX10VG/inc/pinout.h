...
#define HSS_AUX_PWR1    (OUTPUT_PP_50MHZ   | PIN_PORT_D | PIN_NUM_05)
#define HSS_AUX_PWR2    (OUTPUT_PP_50MHZ   | PIN_PORT_D | PIN_NUM_07)
#define HSS_AUX_PWR4    (OUTPUT_PP_50MHZ   | PIN_PORT_B | PIN_NUM_04)
#define HSS_AUX_PWR5    (OUTPUT_PP_50MHZ   | PIN_PORT_C | PIN_NUM_04)
#define HSS_AUX_PWR6    (OUTPUT_PP_50MHZ   | PIN_PORT_D | PIN_NUM_10)
#define HSS_AUX_PWR7    (OUTPUT_PP_50MHZ   | PIN_PORT_B | PIN_NUM_11)
#define HSS_AUX_PWR8    (OUTPUT_PP_50MHZ   | PIN_PORT_B | PIN_NUM_10)
#define HSS_AUX_PWR9    (OUTPUT_PP_50MHZ   | PIN_PORT_E | PIN_NUM_15)
